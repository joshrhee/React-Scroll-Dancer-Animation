    ...
    return (
        <Scroll html>
            <ArticleWrapper ref={article01Ref}>
                <LeftBox>
                    <span>Josh InteracTive Web Project</span>
                    <span>Josh iNteracTive Web Project</span>
                    <span>Josh inTeracTive Web Project</span>
                    <span>Josh iNtEracTive Web Project</span>
                    <span>Josh iNteRacTive Web Project</span>
            ...
            <ArticleWrapper ref={article03Ref}>
                Josh Rhee Dancing Animation Project
            </ArticleWrapper>
            ...
            <ArticleWrapper ref={article08Ref}>
                Josh InteracTive Web Project with React, R3F
                <Footer>
                    {" "}
                    Josh InteracTive Web Project with React, R3F Josh
                    InteracTive Web Project with React, R3F Josh InteracTive Web
                    Project with React, R3F R3F.
                </Footer>
            </ArticleWrapper>
        </Scroll>
    );
